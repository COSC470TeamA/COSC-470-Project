...
public class CameraFragment extends Fragment
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance(getString(R.string.take_photo_request_permission))
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            ErrorDialog.newInstance(getString(R.string.take_photo_camera_error))
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }
    ...
    private void captureStillPicture() {
        try {
            ...
            // Orientation
            int rotation = activity.getWindowManager().getDefaultDisplay().getRotation();
            captureBuilder.set(CaptureRequest.JPEG_ORIENTATION, getOrientation(rotation + 90));
            ...
            case R.id.info: {
                ...
                if (null != activity) {
                    new AlertDialog.Builder(activity)
                            .setMessage(R.string.take_photo_intro_message)
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage(R.string.take_photo_request_permission)
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
